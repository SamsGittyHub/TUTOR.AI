...
export const anthropic: Provider = {
  id: "anthropic",
  label: "Provider 1",
  blurb: "A secondary option for a saved key.",
  keyPrefix: "sk-ant-",
  keyUrl: "",
  ...
  models: [
    {
      ...
      outputPrice: 25,
      vision: true,
      note: "High-depth option for complex reasoning.",
    },
    {
      id: "claude-sonnet-5",
      label: "Balanced",
      ...
      outputPrice: 10,
      vision: true,
      note: "Solid everyday option for study sessions.",
    },
    {
      id: "claude-haiku-4-5",
      label: "Fast",
      ...
      outputPrice: 5,
      vision: true,
      note: "Quick option for lighter review work.",
    },
    {
      id: "claude-opus-4-8",
      label: "Extended",
